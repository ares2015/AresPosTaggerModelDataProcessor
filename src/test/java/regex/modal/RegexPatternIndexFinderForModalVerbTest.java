...
import static com.trainingdataprocessor.regex.RegexExpressions.MODAL_VERB_NOT_RELATIONSHIP_PATTERN;
import static com.trainingdataprocessor.regex.RegexExpressions.MODAL_VERB_RELATIONSHIP_PATTERN;
...
public class RegexPatternIndexFinderForModalVerbTest {
    ...
    @Test
    public void testFindModalVerbRelationshipNoPatternFound() {
        String sentence = "";
        List<RegexPatternIndexData> regexPatternIndexFinderList = null;
        String encodedPath = null;
