...
public final class RegexExpressions {
    ...
    public static final String NOUN_VERB_NOUN_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + "[" + EncodedTags.VERB + EncodedTags.VERB_ED + "]" + AFTER_VERB_NOUN_PHRASE
            +
            AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE;

    public static final String NOUN_VERB_DONT_NOUN_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + EncodedTags.DO + "[" + EncodedTags.VERB + EncodedTags.VERB_ED + "]" +
            ADVERB_SEQUENCE + AFTER_VERB_NOUN_PHRASE + ADVERB_SEQUENCE +
            AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE;

    public static final String NOUN_VERB_DO_NOT_NOUN_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + EncodedTags.DO + EncodedTags.NOT +
    ...
    public static final String NOUN_VERB_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + "[" + EncodedTags.VERB + EncodedTags.VERB_ED + "]"
            +  AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE;

    public static final String NOUN_VERB_DONT_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + EncodedTags.DO + "[" + EncodedTags.VERB + EncodedTags.VERB_ED + "]" +
            ADVERB_SEQUENCE  + ADVERB_SEQUENCE +
            AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE;

    public static final String NOUN_VERB_DO_NOT_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + EncodedTags.DO + EncodedTags.NOT +
            "[" + EncodedTags.VERB + EncodedTags.VERB_ED + "]" +  ADVERB_SEQUENCE +  ADVERB_SEQUENCE +
            AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE;

    public static final String NOUN_MODAL_VERB_RELATION_PATTERN = BEFORE_VERB_PREPOSITION_PHRASE + BEFORE_VERB_NOUN_PHRASE + EncodedTags.DO + "[" + EncodedTags.VERB + EncodedTags.VERB_ED + "]" +
            ADVERB_SEQUENCE  + ADVERB_SEQUENCE +
            AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE + AFTER_VERB_PREPOSITION_PHRASE;
