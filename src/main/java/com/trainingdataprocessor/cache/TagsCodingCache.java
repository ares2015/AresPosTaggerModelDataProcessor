...
public class TagsCodingCache {
    ...
    static {
        ...
        encodingMap.put(Tags.MODAL_VERB_NOT, EncodedTags.MODAL_VERB_NOT);
        ...
        decodingMap.put(EncodedTags.MODAL_VERB_NOT, Tags.MODAL_VERB_NOT);
